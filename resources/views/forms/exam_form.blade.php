            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6 ">
                        ...
                        <input type="text" id="subject" name="subject_name" @error('subject_name') is-invalid @enderror
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" @error('marks') is-invalid @enderror name="marks"
                            id="marks" placeholder="eg 80" autofocus required>
                    </div>
                    @error('marks')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
