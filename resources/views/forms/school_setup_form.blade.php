                        ...
                        <div class="input-group">
                            <div>
                                <input type="text" class="form-control @error('prefix_name') is-invalid @enderror"
                                    ...
                                    value="{{ old('prefix_name') ?? $school->prefix_name }}" autofocus required />
                    ...
                    <div class="input-group">
                        <div>
                            <input type="tel" class="form-control  @error('phone') is-invalid @enderror" placeholder=" "
                                name="phone" id="phone" value="{{ old('phone') ?? $school->phone }}" autofocus
                                required autocomplete="tel" min="10" max="10" />
