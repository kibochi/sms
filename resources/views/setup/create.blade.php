                                        ...
                                        <div class="input-group">
                                            <div>
                                                <input type="text"
                                                    ...
                                                    value="{{ old('school_name') ?? $school->school_name }}" autofocus
                                                    required />
                                    ...
                                    <div class="form-group ">
                                        <div class="inputGroupContainer">
                                            <div class="input-group">
                                                <div>
                                                    <input type="text"
                                                        class="form-control @error('prefix_name') is-invalid @enderror"
                                                        placeholder=" " name="prefix_name" id="prefix_name"
                                                        value="{{ old('prefix_name') ?? $school->prefix_name }}" autofocus
                                                        required />
                                                    <label for="prefix_name">School Prefix Name</label>
                                        ...
                                        <div class="input-group">
                                            <div>
                                                <input type="email"
                                                    ...
                                                    value="{{ old('email') ?? $school->email }}" autofocus required
                                                    autocomplete="email" />
                                        ...
                                        <div class="input-group">
                                            <div>
                                                <input type="tel" class="form-control  @error('phone') is-invalid @enderror"
                                                    ...
                                                    value="{{ old('phone') ?? $school->phone }}" autofocus required
                                        ...
                                        <div class="input-group">
                                            <div>
                                                <input type="text"
                                                    ...
                                                    value="{{ old('address') ?? $school->address }}" autofocus
                                                    required />
